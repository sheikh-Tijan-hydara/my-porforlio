...
<template>
  <div
    class="w-full h-auto lg:h-[60vh] lg:px-24 px-4 py-6 md:py-8 flex flex-col justify-center text-white bg-neutral-950"
  >
        ...
        <div class="flex flex-wrap">
          <Tabs value="0">
            <TabList>
              ...
              <Tab value="2">
                <Avatar image="/amadu.jpg" class="mr-2  ring-4" size="xlarge" shape="circle" />
              </Tab>
            </TabList>
            <TabPanels>
              <TabPanel value="0">
                ...
                <p class="mt-4"><span class="font-bold ">Fatou Gaye</span>, CEO  Wolurek</p>
              </TabPanel>
              <TabPanel value="1">
                <p class="m-0">
