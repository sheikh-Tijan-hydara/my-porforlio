  ...
  >
    <div class="flex lg:flex-row flex-col gap-16 w-full px-8">
      <div class="flex flex-col gap-8 lg:w-1/2 w-full">
        <h2 class="lg:text-4xl text-2xl font-bold pb-2 lg:mb-4">
          SOFTWARE SKILLS
        </h2>
        <h4 class="text-xl font-semibold">WEB DESIGN</h4>
        <div class="flex flex-row gap-4 items-center w-full">
          <div
            class="flex lg:flex-row flex-col gap-4 justify-between lg:items-center w-full"
          >
      ...
      <div class="flex flex-col gap-8 lg:w-1/2 w-full">
        <h2 class="lg:text-4xl text-2xl font-bold pb-2 lg:mb-4 hidden lg:block">
          PERSONAL SKILLS
        </h2>
